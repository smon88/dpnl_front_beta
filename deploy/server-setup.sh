...
# ============================================
read -p "Ingresa el nombre de dominio (ej: tudominio.com): " DOMAIN
read -p "Ingresa usuario de PostgreSQL para el backend: " DB_USER
read -sp "Ingresa password de PostgreSQL para el usuario: " DB_PASSWORD
echo ""
...
# ============================================
# 6. Instalar PostgreSQL (para el backend Node)
# ============================================
...
echo "   - sudo cp nginx/panel.conf /etc/nginx/sites-available/panel"
